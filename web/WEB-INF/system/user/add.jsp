                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                            ...
                            --%>
                            <s:select list="#departments" name="did" listKey="did" listValue="name" cssClass="SelectStyle" headerKey="" headerValue="请选择部门"></s:select>
                        </select>
                        </td>
                    </tr>
                    <tr><td>登录名</td>
                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        ...
                        <td>
                            ...
                            <s:select list="#roles" multiple="true" name="rids" listKey="rid" listValue="name" cssClass="SelectStyle">
